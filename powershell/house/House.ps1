Function Get-Rhyme() {
    ...
    $SubjectActions = [Ordered]@{
        ...
        "toucan in the canopy" = "flapped colorfully"
        ...
        "chimpanzee in the savanna" = "climbed skillfully"
        ...
        "bobcat in the forest" = "ambushed skillfully"
        ...
        "indo-chinese tiger in the grove" = "prowled silently"
        ...
        "pademelon in the underbrush" = "hopped quietly"
        "bettong in the forest" = "foraged at night"
        "potoroo in the scrub" = "hopped cautiously"
        "wallaroo in the outback" = "bounded strongly"
        ...
        "pademelon in the bush" = "hopped softly"
        ...
        "galah in the eucalyptus" = "chatted noisily"
